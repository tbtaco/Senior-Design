/*
 * MAC Address Finder Edited FirmwareUpdater Program
 * This program should be uploaded to an Adafruit Metro M4 and is used to update the firmware on the Wi-Fi module (WINC1500) on the MAC Address Finder Wi-Fi Board.
...
void setup() {
  ...
  // Usage: WiFi.setPins(CS, IRQ, RST, EN) and EN can be -1 if not specified.
  WiFi.setPins(4, 3, 2, -1); // MAC Address Finder Edit
